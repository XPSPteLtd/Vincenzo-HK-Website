...
export const AnnouncementBanner: React.FC<AnnouncementBannerProps> = ({ lang, onDismiss, isActive }) => {
  ...
  return (
    <div className={`absolute top-0 left-0 w-full z-[200] bg-gold h-10 md:h-12 overflow-hidden flex items-center transition-transform duration-1000 ease-out ${isActive ? 'translate-y-0' : '-translate-y-full'}`}>
